...
// SONAR-AUTO-FIX (javascript:S1854): original: // SONAR-AUTO-FIX (javascript:S1481): original: // SONAR-AUTO-FIX (javascript:S1854): original: // SONAR-AUTO-FIX (javascript:S1481): original:     let originalContent = content;
    
    // Удаляем различные типы console.log
    const patterns = [
      // console.log(...)
      /console\.log\([^)]*\);?\s*\n?/g,
      // console.warn(...)
      ...
      /console\.error\([^)]*\);?\s*\n?(?!.*critical|.*fatal|.*error.*critical)/g,
      // console.debug(...)
      /console\.debug\([^)]*\);?\s*\n?/g,
      // console.info(...)
      /console\.info\([^)]*\);?\s*\n?/g,
