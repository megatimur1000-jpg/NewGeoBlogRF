...
import MarkerCompletenessWidget from '../Markers/MarkerCompletenessWidget';
import { useMarkerCompleteness } from '../../hooks/useMarkerCompleteness';
...
const MarkerPopup: React.FC<MarkerPopupProps> = React.memo(({ marker, onClose, onHashtagClick, onMarkerUpdate, onAddToFavorites, onAddToBlog, isFavorite, isSelected }) => {
  ...
  const handleConfirmCategory = () => {
    if (selectedCategory && favorites) {
      favorites.addToFavorites(marker, selectedCategory);
          ...
          {!showCategorySelection ? (
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'center', gap: '8px', marginTop: '12px' }}>
                ...
                <button
                  onClick={() => {
                    // Просто добавляем в избранное без выбора категории
                    onAddToFavorites(marker);
                    onClose();
                  }}
                  style={{
                    padding: '6px 12px',
