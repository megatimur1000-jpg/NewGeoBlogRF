  ...
  return (
    <Wrapper>
      <form onSubmit={handleSubmit}>
        <AccordionBox>
          <Header>Добавить метку</Header>
          
          {/* Информационный блок о культуре меток - показывается только при первой загрузке */}
          {showCultureMessage && (
          <CultureInfo>
            ...
            <React.Fragment key={field.key}>
              <AccordionSection
                ...
                onClick={() => {
                  ...
                  if (field.key === 'title') {
                    setShowCultureMessage(false);
                  }
                  setOpenIdx(openIdx === idx ? null : idx);
                }}
              >
                <IconBox active={openIdx === idx}>
                  {field.icon}
                </IconBox>
                <SectionTitle>
                  {field.label}
                </SectionTitle>
                <CheckCircle completed={isCompleted(field.key)} />
                <Chevron>
                    ...
                    <div>
                      ...
                      {discoveredPlace && (
                        <div style={{ marginBottom: '12px' }}>
                          <Label style={{ fontSize: '0.85em', color: '#666', marginBottom: '4px' }}>
                            🔍 Найдено место:
                          </Label>
                          <div style={{
                            background: '#f8f9fa',
                      ...
                      {photoMode === 'collection' && (
                        <div>
                          {isLoadingPhotos ? (
                            ...
                            <div style={{ padding: 12, textAlign: 'center', color: '#666', background: '#f8f8f8', borderRadius: 6, fontSize: 11 }}>
