...
export const createEvent = async (req, res) => {
  ...
  try {
    ...
    // Проверяем роль пользователя - только админ может создавать сразу активные события
// SONAR-AUTO-FIX (javascript:S1854): original:     let finalStatus = 'pending'; // По умолчанию все требуют модерации
    if (creator_id) {
      ...
      if (userRole === 'admin') {
        // Админ может создать сразу активное событие
        finalStatus = status || 'active';
      } else {
        // Обычные пользователи создают со статусом 'pending'
        finalStatus = 'pending';
      }
    } else {
      // Гости всегда создают со статусом 'pending'
      finalStatus = 'pending';
    }
...
export const searchExternalEvents = async (req, res) => {
  const {
// SONAR-AUTO-FIX (javascript:S1481): original: // SONAR-AUTO-FIX (javascript:S1854): original:     location,
// SONAR-AUTO-FIX (javascript:S1481): original: // SONAR-AUTO-FIX (javascript:S1854): original:     latitude,
// SONAR-AUTO-FIX (javascript:S1481): original: // SONAR-AUTO-FIX (javascript:S1854): original:     longitude,
// SONAR-AUTO-FIX (javascript:S1481): original:     radius = 25,
// SONAR-AUTO-FIX (javascript:S1854): original: // SONAR-AUTO-FIX (javascript:S1481): original:     start_date,
// SONAR-AUTO-FIX (javascript:S1481): original: // SONAR-AUTO-FIX (javascript:S1854): original:     end_date,
// SONAR-AUTO-FIX (javascript:S1481): original: // SONAR-AUTO-FIX (javascript:S1854): original:     category,
// SONAR-AUTO-FIX (javascript:S1854): original: // SONAR-AUTO-FIX (javascript:S1481): original:     query,
// SONAR-AUTO-FIX (javascript:S1481): original:     limit = 20
  } = req.query;
