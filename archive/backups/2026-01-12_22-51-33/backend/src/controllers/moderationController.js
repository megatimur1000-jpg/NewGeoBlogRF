...
// SONAR-AUTO-FIX (javascript:S1128): original: import { requireRole } from '../middleware/auth.js';
...
export const getPendingContent = async (req, res) => {
  try {
    ...
    switch (contentType) {
      case 'events':
// SONAR-AUTO-FIX (javascript:S1854): original:         tableName = 'events';
        query = `
      ...
      case 'posts':
// SONAR-AUTO-FIX (javascript:S1854): original:         tableName = 'posts';
        query = `
      ...
      case 'routes':
// SONAR-AUTO-FIX (javascript:S1854): original:         tableName = 'travel_routes';
        query = `
      ...
      case 'markers':
// SONAR-AUTO-FIX (javascript:S1854): original:         tableName = 'map_markers';
        query = `
      ...
      case 'blogs':
// SONAR-AUTO-FIX (javascript:S1854): original:         tableName = 'blog_posts';
        query = `
...
// SONAR-AUTO-FIX (javascript:S1854): original:         tableName = 'comments';
        query = `
...
// SONAR-AUTO-FIX (javascript:S1854): original:         tableName = 'chat_messages';
        query = `
          SELECT m.*, u.username as creator_name 
...
// SONAR-AUTO-FIX (javascript:S1854): original: // SONAR-AUTO-FIX (javascript:S1481): original:     const deleteResult = await pool.query(
